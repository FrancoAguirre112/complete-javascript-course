...
TEST DATA 1: Marks weights 78 kg and is 1.69 m tall. Johns weights 92 kg and is 1.95 m tall.
...
1. Print a output to the console, saying who has the higher BMI. the message
can be either "Mark's BMI is higher than John's!" or "John's BMI is higher 
than Mark's!"
2. Use a template string to inclue the BMI values in the outputs. Example:
...
} else console.log('Nobody wins, points less than 100');
*/
